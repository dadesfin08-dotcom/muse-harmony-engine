            ...
            <LanguageSwitcher
              trigger={
                <button
                  ...
                  className="relative inline-flex h-14 w-14 -translate-y-4 items-center justify-center rounded-full border-3 border-white bg-gradient-to-tr from-emerald-600 to-emerald-400 text-white shadow-[0_0_15px_rgba(16,185,129,0.6)] [filter:drop-shadow(0_0_25px_rgba(16,185,129,0.3))] transition-transform duration-200 hover:scale-110 sm:h-16 sm:w-16 sm:-translate-y-5 sm:border-4"
                >
